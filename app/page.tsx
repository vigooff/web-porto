            ...
            <div className="about-grid">
              <div className="about-content reveal">
                ...
                <div style={{marginTop: '2rem'}}>
                  ...
                  <a href="https://wa.me/6285733876080" target="_blank" rel="noopener noreferrer" className="contact-item">
                  ...
                  <a href="https://www.linkedin.com/in/vigo-satria-472853408?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noopener noreferrer" className="contact-item">
                    <svg viewBox="0 0 24 24" fill="currentColor">
...
{['React', 'Next.js', 'Tailwind', 'Framer Motion'].map((t: string) => <span key={t} className="skill-item">{t}</span>)}
                ...
                <div className="about-card">
                  ...
                  <div style={{fontSize: '0.9rem', color: 'var(--gray-600)'}}>
                    • Finalist Top 27 Telkom Business Idea Challenge 2025<br/>
